...
class BoxPushing(gym.Env):
    ...
    def __init__(self, grid_dim=(4,4), terminate_step=100, random_init=False, small_box_only=False, big_box_only=False,
                 terminal_reward_only=False, big_box_reward=100, small_box_reward=10, *args, **kwargs):
        ...
        self.state_space = spaces.Box(high=1, low=0, shape=(6+6+6,), dtype=np.float32)
