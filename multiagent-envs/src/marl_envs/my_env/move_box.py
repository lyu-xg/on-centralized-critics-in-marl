...
class MoveBox(object):
    def __init__(self, max_step=5000):
        self.n_agent = 2
        self.max_step = max_step
        self.observation_space = spaces.Box(low=-1, high=1, shape=(15*15,), dtype=np.int32)
    ...
    def get_observation(self):
        obs = np.zeros((15, 15))
        obs[self.agt1_pos[0], self.agt1_pos[1]] = 1
        obs[self.agt2_pos[0], self.agt2_pos[1]] = -1
        return [obs.reshape(-1), obs.reshape(-1)]
