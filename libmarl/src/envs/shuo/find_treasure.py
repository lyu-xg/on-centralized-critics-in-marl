...
class EnvFindTreasure(object):
    ...
    def step(self, action_list):
        ...
        if (self.agt1_pos == self.sub_pos and self.agt2_pos == self.lever_pos) or (
            self.agt1_pos == self.lever_pos and self.agt2_pos == self.sub_pos
        ):
            reward = reward + 3
    ...
    def get_agt1_obs(self):
        ...
        for i in range(3):
            for j in range(3):
                if (
                    self.occupancy[self.agt1_pos[0] - 1 + i][self.agt1_pos[1] - 1 + j]
                    == 0
                ):
                    obs[i, j, 0] = 1.0
                    obs[i, j, 1] = 1.0
    ...
    def get_agt2_obs(self):
        ...
        for i in range(3):
            for j in range(3):
                if (
                    self.occupancy[self.agt2_pos[0] - 1 + i][self.agt2_pos[1] - 1 + j]
                    == 0
                ):
                    obs[i, j, 0] = 1.0
                    obs[i, j, 1] = 1.0
